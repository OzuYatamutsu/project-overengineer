...
The password is autogenerated and stored in the kubernetes secret `grafana-admin-password` (i.e. `kubectl get secret -n monitoring-plane grafana-admin-password -o yaml`).
