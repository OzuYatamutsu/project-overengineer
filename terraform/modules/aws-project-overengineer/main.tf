    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          ...
          "token.actions.githubusercontent.com:sub" = "repo:OzuYatamutsu/project-overengineer:ref:refs/heads/feature/distributed-metrics"
        }
      }
    }]
  })
...
module "vpc" {
  ...
  name = "internal-${var.environment_name}"
